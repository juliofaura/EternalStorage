...
interface IEternalStorageBoolDoubleMapping {
    ...
    function getBoolFromDoubleAddressStringMapping(bytes32 _module, bytes32 _mapping, address _key1, string calldata _key2) external view returns (bool);
    ...
    function setBoolInDoubleAddressStringMapping(bytes32 _module, bytes32 _mapping, address _key1, string calldata _key2, bool _value) external returns (bool);
    ...
    function deleteBoolFromDoubleAddressStringMapping(bytes32 _module, bytes32 _mapping, address _key1, string calldata _key2) external returns (bool);
